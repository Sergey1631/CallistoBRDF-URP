...
{
    public class CallistoLitShader : BaseShaderGUI
    {
        static readonly string[] workflowModeNames = Enum.GetNames(typeof(LitGUI.WorkflowMode));

        private LitGUI.LitProperties litProperties;
        private LitDetailGUI.LitProperties litDetailProperties;
        private CallistoBRDF_GUI.CallistoBRDFProperties callistoBrdfProperties;
        private MaterialProperty terminatorLength;
        ...
        public override void FillAdditionalFoldouts(MaterialHeaderScopeList materialScopesList)
        {
            ...
            materialScopesList.RegisterHeaderScope(new GUIContent("Callisto BRDF"), 
                true, _ => CallistoBRDF_GUI.DoCallistoBRDFArea(callistoBrdfProperties, materialEditor));
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            callistoBrdfProperties = new CallistoBRDF_GUI.CallistoBRDFProperties(properties);
        }
